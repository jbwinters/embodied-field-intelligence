...
def main():
    ...
    ap.add_argument("--frames-dir", type=Path,
                    help="optionally retain the captured PNG frames for inspection")
        ...
        for i, t in enumerate(steps):
            ...
            subprocess.run(
                [chrome, "--headless", "--disable-gpu", "--hide-scrollbars",
                 ...
                 f"--user-data-dir={Path(td) / 'chrome-profile'}",
            ...
            if args.frames_dir:
                ...
                img.save(args.frames_dir / f"f{i:04d}.png")
            frames.append(img)
            if (i + 1) % 10 == 0:
    ...
    frames[0].save(out, save_all=True, append_images=frames[1:],
                   duration=int(1000 / args.fps), loop=0, disposal=2, optimize=False)
